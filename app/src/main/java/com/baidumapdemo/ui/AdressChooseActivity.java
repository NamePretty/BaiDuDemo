...
import com.baidumapdemo.adapter.MapAdapter;
...
import com.baidumapdemo.util.MapPositioning;
...
public class AdressChooseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adress_choose);
    ...
    private void initView(){
        ...
        rl_list.addItemDecoration(new DividerItemDecoration(this, LinearLayoutManager.VERTICAL));
        ...
        rl_list.setAdapter(mMapAdapter);
    }

    @OnClick({R.id.iv_location,R.id.iv_search,R.id.tv_sure})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.iv_location:
                ...
                break;
            case R.id.iv_search:
                startActivityForResult(new Intent(AdressChooseActivity.this, SearchCityActivity.class), AppStaticVariable.MAP_SEARCH_CODE);
                break;
            case R.id.tv_sure:
                doSure();
                break;
    ...
    public void initUserLocation() {
        ...
        mapPositioning.setmLocation(new MapPositioning.XbdLocation() {
            ...
            public void locFailure(int errorType, String errorString) {
                mProgressDialog.dismiss();
                ToastUtil.show(AdressChooseActivity.this,errorString);
            }
        });
        ...
        AndPermission.with(this)
                ...
                .onDenied(new Action<List<String>>() {
                    ...
                    public void onAction(@NonNull List<String> permissions) {
                        com.baidumapdemo.util.ToastUtil.show(AdressChooseActivity.this, "定位权限被拒绝，请手动开启！");
                        if (AndPermission.hasAlwaysDeniedPermission(AdressChooseActivity.this, permissions)) {
                            PermissionTool.showSettingDialog(AdressChooseActivity.this, permissions);
                        }
                    }
                })
                .start();
    ...
    public void doSure() {
        if (mMapAdapter.getDatas().size() > 0) {
            ...
            ToastUtil.show(AdressChooseActivity.this,"经度:" + item.location.longitude + "-纬度:" + item.location.latitude + "-地址:" + item.address);
            tv_title.setText(item.address);
        } else {
            ToastUtil.show(AdressChooseActivity.this,"请选择地址");
        }
    }
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent(context, AdressChooseActivity.class);
